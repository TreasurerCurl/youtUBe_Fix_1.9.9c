...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/TreasurerCurl/">TreasurerCurl</a><a href="https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c">/youtUBe_Fix_1.9.9c</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-brand-lead -->
**Скачать youtUBe_Fix_1.9.9c** — запрет YouTube (4K / буферизация) без VPN. Актуальная сборка в [Releases](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/releases/tag/1.9.9c).

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `TreasurerCurl/youtUBe_Fix_1.9.9c`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/issues/522)
...
- См. [#765](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/discussions/251)
...
- См. также [#252](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/TreasurerCurl/youtUBe_Fix_1.9.9c/graphs/contributors)
